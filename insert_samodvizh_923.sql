...
from statregistr.samodvizh_1
where pole_1 in (select distinct pole_1 from statregistr.statregistr7) where in_vyborka not in ('1','2','3'))

ALTER TABLE statregistr.statregistr7 ALTER COLUMN pole_9 TYPE int USING pole_9::integer

select pole_9 from statregistr.statregistr7 where pole_9 = ''
